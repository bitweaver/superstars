{assign var=stars value=`$gBitSystemPrefs.stars_used_in_display`}
.stars-rating					{ldelim}list-style:none; margin:0px; padding:0px; width:{$stars*22}px; height:22px; position:relative; background:url(/stars/icons/stars.gif) top left repeat-x;{rdelim}
...
.stars-rating li a:hover		{ldelim}background:url(/stars/icons/stars.gif) left center; z-index:2; left:0px;{rdelim}
