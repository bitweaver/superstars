...
.stars-rating					{ldelim}list-style:none; margin:0px; padding:0px; width:{$stars*22}px; height:22px; position:relative; background:red url( {$smarty.const.STARS_PKG_URL}icons/stars.gif ) top left repeat-x;{rdelim}
